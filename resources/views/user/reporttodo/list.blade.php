...
<div class="box-header d-flex justify-content-end mb-3">
    <div class="btn-group">
        <a href="{{ route('user.reporttodo.create') }}" class="btn btn-secondary">
...
<div class="container">
    <div class="mb-2">
        <!-- Search -->
        <form action="{{ route('user.reporttodo.search') }}" method="GET" class="form-inline mt-3">
            ...
            <tr class="text-center">
                ...
                <td>
                    ...
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="{{ route('user.reporttodo.edit', $report->reporttodo_uuid) }}" class="btn btn-secondary btn-sm mr-1">Edit</a>
                        <a href="{{ route('user.reporttodo.konfirmasi', $report->reporttodo_uuid) }}" class="btn btn-danger btn-sm">Hapus</a>
                    </div>
                    @endif
                </td>
            </tr>
